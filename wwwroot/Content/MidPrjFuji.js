...
{
 "use strict";
 var MidPrjFuji,App,WebSharper,Arrays,Operators,Obj,UI,Templating,Runtime,Server,ProviderBuilder,TemplateHole,Var,Pages,Charting,Renderers,ChartJs,Chart,Charts,BarChart,Pervasives,Color,View,TemplateInstance,TemplateHoleModule,Elt,Text,Unchecked,System,Guid,SC$1,ChartJsInternal,Client,Templates,Doc,JavaScript,Pervasives$1,CompositeChart,Object,Numeric,ListModel,MidPrjFuji_Templates,MidPrjFuji_Router,Handler,EventTarget,Node,WindowOrWorkerGlobalScope,JS,Var$1,Router,Seq,ADataSet,ChartConfig,SeriesChartConfig,SC$2,Collections,Dictionary,Control,FSharpEvent,SC$3,Snap,VarStr,EventQ,Docs,HashSet,TemplateInitializer,VarFloatUnchecked,VarBool,VarDateTime,VarFile,VarDomElement,ConcreteVar,Sitelets,RouterOperators,RouterModule,Route,HtmlModule,attr,AttrModule,Element,HTMLElement,Enumerator,T,Option,Slice,BatchUpdater,Util,Seq$1,Reactive,Reactive$1,List,T$1,SC$4,Event,Event$1,ColorConfig,Random,PolarData,DictionaryUtil,Abbrev,Fresh,Storage,Router$1,List$1,AttrProxy,Attrs,DomUtility,Prepare,KeyCollection,DocElemNode,CharacterData,Blob,Elt$1,An,Settings,Mailbox,ArrayStorage,FSharpMap,Map,Strings,Utils,Concurrency,Attrs$1,Dyn,Attribute,Event$2,AfterRender,AfterRenderQ,Array,Updates,ValueCollection,Docs$1,RunState,NodeSet,Anims,SC$5,SC$6,BalancedTree,Tree,Pair,SC$7,Queue,HashSetUtil,SC$8,AppendList,MapUtil,Scheduler,PathUtil,Error,KeyNotFoundException,DynamicAttrNode,SC$9,Easing,AsyncBody,SC$10,CT,HashSet$1,BindVar,String,CheckedInput,CancellationTokenSource,DomNodes,Char,DateUtil,OperationCanceledException,Lazy,SC$11,LazyExtensionsProxy,LazyRecord,Math,Runtime$1,console,Date;
 ...
 App.Main=function()
 {
  var builder,M,_this,_this$1,_this$2,p,_;
  builder=(M=Doc.EmbedView(View.Map(function(endpoint)
  {
   return endpoint.$==1?Pages.Page1():Pages.HomePage();
  },App.currentPage().get_View())),(_this=(_this$1=(_this$2=new ProviderBuilder.New$1(),(_this$2.h.push(new Text.New("url_home","/")),_this$2)),(_this$1.h.push(new Text.New("url_page1","/#/page1")),_this$1)),(_this.h.push(new Elt.New("maincontainer",M)),_this)));
  p=Handler.CompleteHoles(builder.k,builder.h,[]);
  builder.i=new TemplateInstance.New(p[1],Templates.RunFullDocTemplate(p[0]));
  Pages.counter().Get();
  _=ChartJs.Render$1(Chart.Combine([Chart.Bar$1(Arrays.zip(["January","Febrary","March","April","You"],[250000,260000,290000,300000,0])).__WithFillColor(new Color({
   $:0,
   $0:151,
   $1:187,
   $2:205,
 ...
 {
  var b,_this,L,_this$1,p,i;
  function a(company,price)
  {
   var b$1,_this$2,_this$3,p$1,i$1;
   return(b$1=(_this$2=(_this$3=new ProviderBuilder.New$1(),(_this$3.h.push(new Text.New("company",company)),_this$3)),(_this$2.h.push(new Text.New("price",price)),_this$2)),(p$1=Handler.CompleteHoles(b$1.k,b$1.h,[]),(i$1=new TemplateInstance.New(p$1[1],MidPrjFuji_Templates.listitem2(p$1[0])),b$1.i=i$1,i$1))).get_Doc();
  }
  return(b=(_this=(L=Doc.Convert(function($1)
  {
   return a($1[0],$1[1]);
  },Pages.Stock().v),(_this$1=new ProviderBuilder.New$1(),(_this$1.h.push(new Elt.New("listcontainer2",L)),_this$1))),(_this.h.push(new VarStr.New("company",Pages.newCompany())),_this)),(p=Handler.CompleteHoles(b.k,b.h,[["company",0,null]]),(i=new TemplateInstance.New(p[1],MidPrjFuji_Templates.page1(p[0])),b.i=i,i))).get_Doc();
 };
 Pages.HomePage=function()
 {
  var b,t,_this,_this$1,_this$2,_this$3,L,_this$4,p,i;
  function a(month,salary,utility,food,balance)
  {
   var b$1,_this$5,_this$6,_this$7,_this$8,_this$9,p$1,i$1;
   return(b$1=(_this$5=(_this$6=(_this$7=(_this$8=(_this$9=new ProviderBuilder.New$1(),(_this$9.h.push(new Text.New("month",month)),_this$9)),(_this$8.h.push(new Text.New("salary",salary)),_this$8)),(_this$7.h.push(new Text.New("utility",utility)),_this$7)),(_this$6.h.push(new Text.New("food",food)),_this$6)),(_this$5.h.push(new Text.New("balance",balance)),_this$5)),(p$1=Handler.CompleteHoles(b$1.k,b$1.h,[]),(i$1=new TemplateInstance.New(p$1[1],MidPrjFuji_Templates.listitem(p$1[0])),b$1.i=i$1,i$1))).get_Doc();
  }
  return(b=(t=(_this=(_this$1=(_this$2=(_this$3=(L=Doc.Convert(function($1)
  {
   return a($1[0],$1[1],$1[2],$1[3],$1[4]);
  },Pages.Balance().v),(_this$4=new ProviderBuilder.New$1(),(_this$4.h.push(new Elt.New("listcontainer",L)),_this$4))),(_this$3.h.push(new VarStr.New("month",Pages.newMonth())),_this$3)),(_this$2.h.push(new VarStr.New("salary",Pages.newSalary())),_this$2)),(_this$1.h.push(new VarStr.New("utility",Pages.newUtility())),_this$1)),(_this.h.push(new VarStr.New("food",Pages.newFood())),_this)),(t.h.push(Handler.EventQ2(t.k,"add",function()
  {
   return t.i;
  },function()
  {
   var balance,chart,_;
   balance=Operators.toInt(Global.Number(Pages.newSalary().Get()))-Operators.toInt(Global.Number(Pages.newUtility().Get()))-Operators.toInt(Global.Number(Pages.newFood().Get()));
   Pages.newBalance().Set(Global.String(balance));
   Pages.Balance().Append([Pages.newMonth().Get(),Pages.newSalary().Get(),Pages.newUtility().Get(),Pages.newFood().Get(),Pages.newBalance().Get()]);
   chart=Chart.Combine([Chart.Bar$1(Arrays.zip(["January","Febrary","March","April",Pages.newMonth().Get()],[250000,260000,290000,300000,Operators.toInt(Global.Number(Pages.newBalance().Get()))])).__WithFillColor(new Color({
    $:0,
    $0:151,
    $1:187,
    $2:205,
   ...
   self.document.getElementById("Chart1").innerHTML="";
   _=ChartJs.Render$1(chart,{
    $:1,
    $0:{
     $:0,
     $0:600,
   ...
   Templates.LoadLocalTemplates("");
   Doc.RunAppendById("Chart1",_);
  })),t)),(p=Handler.CompleteHoles(b.k,b.h,[["month",0,null],["salary",0,null],["utility",0,null],["food",0,null]]),(i=new TemplateInstance.New(p[1],MidPrjFuji_Templates.homepage(p[0])),b.i=i,i))).get_Doc();
 };
 Pages.newCompany=function()
 {
  SC$1.$cctor();
  return SC$1.newCompany;
 };
 ...
 Pages.newFood=function()
 {
  SC$1.$cctor();
  return SC$1.newFood;
 };
 Pages.newUtility=function()
 {
  SC$1.$cctor();
  return SC$1.newUtility;
 };
 Pages.newSalary=function()
 {
  SC$1.$cctor();
  return SC$1.newSalary;
 };
 Pages.newMonth=function()
 {
  SC$1.$cctor();
  return SC$1.newMonth;
 };
 ...
 Pages.newBalance=function()
 {
  SC$1.$cctor();
  return SC$1.newBalance;
 };
 ...
 SC$1.$cctor=function()
 {
  ...
  SC$1.newMonth=Var$1.Create$1("");
  SC$1.newSalary=Var$1.Create$1("");
  SC$1.newUtility=Var$1.Create$1("");
  SC$1.newFood=Var$1.Create$1("");
  SC$1.newBalance=Var$1.Create$1("");
  SC$1.Balance=ListModel.FromSeq([["January","500000","150000","100000","250000"],["Febrary","500000","142000","98000","260000"],["March","500000","120000","90000","290000"],["April","500000","100000","100000","300000"]]);
  ...
  SC$1.Stock=ListModel.FromSeq([["a company","0.5"],["b company","1.0"],["c company","0.5"]]);
  SC$1.newCompany=Var$1.Create$1("");
  SC$1.newPrice=Var$1.Create$1("");
 ...
 MidPrjFuji_Templates.listitem2=function(h)
 {
